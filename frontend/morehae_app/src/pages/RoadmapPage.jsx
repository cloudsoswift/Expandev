...
const RoadmapPage = () => {
  ...
  const [roleList, setRoleList] = useState([{id:0, content:"내용이 없습니다"}]);
  ...
  useEffect(() => {
    ...
    axios.get('https://ssekerapi.site/roadmaps/roles')
      .then((Response)=>{
    ...
    axios.get('https://ssekerapi.site/roadmaps/1')
      .then((Response)=>{
    ...
    <div className="bg-blue-100">
      <div className="flex justify-center">
        <div ref={DropdownRefA}>
          <Dropdown isOpenRole={isOpenRoleA} setIsOpenRole={setIsOpenRoleA} selectedRole={selectedRole} setSelectedRole={setSelectedRole} roleList={roleList} />
        </div>
